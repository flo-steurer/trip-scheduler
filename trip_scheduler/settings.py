...
ROOT_URLCONF = "trip_scheduler.urls"
TEMPLATES = [{
...
WSGI_APPLICATION = "trip_scheduler.wsgi.application"
...
WORLD_CUP_SYNC_INTERVAL_SECONDS = int(os.environ.get("WORLD_CUP_SYNC_INTERVAL_SECONDS", "60"))
